...
class FileTests(unittest.TestCase):
    ...
    def test_type_screen_2(self):
        ...
        self.assertEqual(file.data[0x2000], 0x38)
        self.assertEqual(file.data[0x37ff], 0x38)
        self.assertEqual(file.data[0x3800], 0x00)
    ...
    def test_type_screen_3(self):
        ...
        self.assertEqual(file.data[0x6000], 0x00)
